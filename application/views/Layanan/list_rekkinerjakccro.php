                    ...
                    <table id="tableBarang" class="table table-bordered" style="width: 100%;">
                        <thead>
                            <tr role="row">
                                <th>No</th>
                                <th>Laba Rugi</th>
                                <th>Status Pencapaian vs RKA Pendapatan</th>
                                <th>Status Pencapaian vs RKA Biaya</th>
                                <th>Status Pencapaian vs RKA Laba Rugi</th>
                                <th>Nama Kanca</th>
                                <th>Nama Pembina</th>
                                <th>Jumlah CIT</th>
                                <th>RKA Pendapatan</th>
                                <th>RKA Biaya</th>
                                <th>RKA Laba Rugi</th>
                                <th>Pencapaian vs RKA Pendapatan</th>
                                <th>Pencapaian vs RKA Biaya</th>
                                <th>Pencapaian vs RKA Laba Rugi</th>
                                <th>Laba Rugi PerBulan PerCIT</th>
                                <th>Laba Rugi PerBulan Kontribusi Pekerja</th>
                                <th>Rasio SDM</th>
                                <th>Total Pencapaian Pendapatan</th>
                                <th>Total Pencapaian Biaya</th>
                                <th>Total Pencapaian Laba Rugi</th>
                                <th>Total Pencapaian BOPO</th>
                                <th>Prognosa sd Desember Pendapatan</th>
                                <th>Prognosa sd Desember Biaya</th>
                                <th>Prognosa sd Desember Laba Rugi</th>
                                <th>User</th>
...
<script>
    const urlRekkinerjakccro = '<?= site_url("Rekkinerjakccro/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlRekkinerjakccro + "listRekkinerjakccro",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
