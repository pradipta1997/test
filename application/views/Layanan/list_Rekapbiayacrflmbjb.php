                    ...
                    <table id="tableBarang" class="table table-bordered" style="width: 100%;">
                        <thead>
                            <tr role="row">
                                <th>No</th>
                                <th>ID</th>
                                <th>Tgl Perdana Pengisian ATM</th>
                                <th>Hari</th>
                                <th>Cabang</th>
                                <th>ATM</th>
                                <th>BG</th>
                                ...
                                <th>Versi BJB CR</th>
                                <th>Versi BJB FLM</th>
                                <th>Versi BJB CR & FLM</th>
                                <th>BJB CR & FLM 1</th>
                                <th>Versi BG FLM</th>
                                <th>Versi BG CR & FLM</th>
                                <th>Biaya</th>
                                <th>Keterangan</th>
                                <th>Total Biaya</th>
                                <th>True / False</th>
...
<script>
    const urlRekapbiayacrflmbjb = '<?= site_url("Rekapbiayacrflmbjb/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlRekapbiayacrflmbjb + "listRekapbiayacrflmbjb",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
