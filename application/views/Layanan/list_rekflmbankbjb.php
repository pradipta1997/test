                    ...
                    <table id="tableBarang" class="table table-bordered" style="width: 100%;">
                        <thead>
                            <tr role="row">
                                ...
                                <th>Problem ke 1</th>
                                <th>Tanggal ke 1</th>
                                <th>Waktu Request ke 1</th>
                                <th>No Ticket Catatan BG</th>
                                <th>User</th>
...
<script>
    const urlRekflmbankbjb = '<?= site_url("Rekflmbankbjb/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlRekflmbankbjb + "listRekflmbankbjb",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
