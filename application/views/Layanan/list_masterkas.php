                    ...
                    <table id="tableBarang" class="table table-bordered" style="width: 100%;">
                        <thead>
                            <tr role="row">
                                ...
                                <th>Tanggal</th>
                                <th>Code Branch</th>
                                <th>Saldo Awal Bri</th>
                                <th>Uang Layak</th>
                                <th>Uang Meragukan/Palsu</th>
                                <th>Uang Tdk Layak Edar</th>
                                <th>Total Saldo Awal Penambahan</th>
                                <th>Tambahan Kas RPL</th>
                                <th>Tukar Uang Tdk Layak Edar</th>
                                <th>Kas Atm Return</th>
                                <th>Sub Total</th>
                                <th>Total Saldo Awal Pengurangan</th>
                                <th>Shortage</th>
                                <th>Atm Replenish</th>
                                <th>Subtotal Pengurangan</th>
                                <th>Saldo Akhir BRI</th>
                                <th>Cabang</th>
                                <th>User</th>
...
<script>
    const urlMasterkas = '<?= site_url("Masterkas/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlMasterkas + "listMasterkas",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
