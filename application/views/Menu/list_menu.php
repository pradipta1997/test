        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <span <?php echo $My_Controller->savePermission; ?>>
                    | <button id="addMenu" class='btn btn-info'> Add New <i class="fa fa-plus"></i></a>
                </span>
            </header>
            <div class="panel-body">
                <table id="tableMenu" class="table table-bordered" style="width: 100%;">
                    <thead>
                        <tr role="row">
                            <th>No</th>
                            <th>Nama Menu</th>
