        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <span <?php echo $My_Controller->savePermission; ?>>
                    | <button type="button" id='addGroupuser' class='btn btn-info'>
                        Add New <i class="fa fa-plus"></i>
                    </button>
                </span>
            </header>
            <div class="panel-body">
                <table id="tableGroupuser" class="table table-bordered" style="width: 100%;">
                    <thead>
                        <tr role="row">
                            <th>No</th>
                            <th>Nama Group</th>
...
<script>
    ...
    function activeGroupuser(id_group) {
        Swal.fire({
            title: "Are you sure?",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    url: urlGroupuser + "activeGroupuser",
                    dataType: 'JSON',
                    success: function(response) {
                        if (response) {
