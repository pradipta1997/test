                    ...
                    <form action="<?= base_url('Permission/createPermission/' . $this->uri->segment(3)) ?>" class="form-horizontal group-border hover-stripped" method="post">
                        <table class="display table table-bordered table-striped" id="dynamic-table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td style="background-color: #67809f; border-color: #67809f; color:white;  opacity: 0.8;filter: alpha(opacity=80);">
                                            <?php echo "<span style='font-size:16px; '>" . $parentnav_list_data->nama_menu . "</span>"; ?>
                                        </td>
                                        <?php if ($parentnav_list_data->parent_id != 0) {
                                            $menuid = $parentnav_list_data->id_menu;
                                        } else { ?>
                                            <td>
                                                <input type="checkbox" <?= $view == 1 ? "checked" : '' ?> class="make-switch" data-on-color="info" data-off-color="danger" data-size="medium" name="permission[view][<?php echo $parentnav_list_data->id_menu; ?>]">
                                            </td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" <?= $view == 1 ? "checked" : '' ?> class="make-switch" data-on-color="info" data-off-color="danger" data-size="medium" name="permission[view][<?php echo $secondChildrow_data->id_menu; ?>]">
                                                </td>
                                                <td>
                                                    <input type="checkbox" <?= $insert == 1 ? "checked" : '' ?> class="make-switch" data-on-color="info" data-off-color="danger" data-size="medium" name="permission[insert][<?php echo $secondChildrow_data->id_menu; ?>]">
                                                </td>
                                                <td>
                                                    <input type="checkbox" <?= $update == 1 ? "checked" : '' ?> class="make-switch" data-on-color="info" data-off-color="danger" data-size="medium" name="permission[update][<?php echo $secondChildrow_data->id_menu; ?>]">
                                                </td>
                                                <td>
                                                    <input type="checkbox" <?= $delete == 1 ? "checked" : '' ?> class="make-switch" data-on-color="info" data-off-color="danger" data-size="medium" name="permission[delete][<?php echo $secondChildrow_data->id_menu; ?>]">
                                                </td>
                                            </tr>
                                            <?php
                        ...
                        <a href="<?= base_url('Subgroupuser') ?>" class="btn btn-success">Kembali</a>
                    </form>
                </div>
            </div>
        </div>
