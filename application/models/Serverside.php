...
class Serverside extends CI_Model
{
    ...
    public function _serverSideCustom($table, $columnOrder = null, $columnSearch = null, $order = null, $where = null, $tipeResult = null)
    {
        $this->db->from($table);
        is_null($where) ?: $this->db->where($where);
        $i = 0;
    ...
    public function _countAllCustom($table, $where = null)
    {
        $this->db->from($table);
        is_null($where) ?: $this->db->where($where);
        return $this->db->count_all_results();
