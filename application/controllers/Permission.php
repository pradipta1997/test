        ...
        foreach ($menus as $menus) {
            ...
            if ($per_groupmenu > 0) {
                $data = array(
                    ...
                    "per_update" => $update,
                    "per_delete" => $delete,
                    'per_updated_date' => date('Y-m-d H:i:s'),
                    'per_updated_by' => $this->session->userdata('user_login')['username']
                );
                ...
                $data = array(
                    ...
                    "per_update" => $update,
                    "per_delete" => $delete,
                    'per_created_date' => date('Y-m-d H:i:s'),
                    'per_created_by' => $this->session->userdata('user_login')['username']
                );
