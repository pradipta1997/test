            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="date" name="tgl_pembelian" id="tgl_pembelian" value="<?= date('Y-m-d') ?>" class="form-control">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="text" name="tempo_pembayaran" id="tempo_pembayaran" class="form-control" title="Input Tempo Pembayaran">
                    </div>
                </div>
                            ...
                            <tbody id="rows-list">
                                <tr>
                                    ...
                                    <td class="product-list">
                                        ...
                                        <select class="form-control PemlocId_currency" name="id_currency[]">
                                    ...
                                    <td>
                                        <input type="number" name="qty[]" value="0" class="form-control PemlocQty">
                                    </td>
                                    <td>
                                        <input type="number" name="harga_satuan[]" value="0" class="form-control PemlocHargasatuan">
                                    </td>
                                    ...
                                    <td>
                                        <input type="text" name="keterangan[]" class="form-control pemlocKet">
                                    </td>
                                    <td align="center">
